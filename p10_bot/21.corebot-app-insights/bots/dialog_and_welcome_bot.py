...
from botbuilder.core    ConversationState, UserState
from botbuilder.core    BotTelemetryClient
...
class Bot_principal(DialogBot):
    ...
    def __init__(self,conversation_state: ConversationState,user_state: UserState,dialog: Dialog,telemetry_client: BotTelemetryClient):
        super(Bot_principal, self).__init__(conversation_state, user_state, dialog, telemetry_client)
    ...
    async def on_members_added_activity(self, members_added: List[ChannelAccount], turn_context: TurnContext):
        for member in members_added:
            ...
            #
            # C'est la qu'il faut greeter les 
            #
